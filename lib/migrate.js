...
const tasks = {
    ...
    noVar(appPath) {
        try {
            ...
            spinner.start();
            execSync(`jscodeshift -t ${cwd}/lib/codemods/js-codemod/transforms/no-vars.js ${appPath}`);
    ...
    templateLiteral(appPath) {
        try {
            ...
            spinner.start();
            execSync(`jscodeshift -t ${cwd}/lib/codemods/js-codemod/transforms/template-literals.js ${appPath}`);
    ...
    arrowFunction(appPath) {
        try {
            ...
            spinner.start();
            execSync(`jscodeshift -t ${cwd}/lib/codemods/js-codemod/transforms/arrow-function.js ${appPath}`);
